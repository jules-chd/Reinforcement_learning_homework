...
def train_model(env, model, optimizer, gamma=0.99, episodes=200, epsilon_start=1.0, epsilon_end=0.01, epsilon_decay=0.995, batch_size=32, target_update_frequency=10):
    """
